...
const FILES = ['/donations/index.html', '/donations/donations.json', '/4chan/index.html', '/4chan/threads.json', '/courses/index.html', '/courses/courses.json', '/index.html', '/physicians/index.html', '/story.html', '/timeline-data.js', '/law/index.html'];
